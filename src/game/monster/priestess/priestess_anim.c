...
mmove_t priestess_move_attack1_end = {FRAME_attackA13, FRAME_attackA16, priestess_frames_attack1_end, priestess_pause};
...
mmove_t priestess_move_jump_attack = {FRAME_jumpatt1, FRAME_jumpatt14, priestess_frames_jump_attack, priestess_pause};
