...
mmove_t priestess_move_stand1 = {FRAME_idle1, FRAME_idle18, NULL, priestess_idle, priestess_frames_stand1};
...
mmove_t priestess_move_attack1_go = {FRAME_attackA7, FRAME_attackA16, NULL, priestess_attack1_pause, priestess_frames_attack1_go};
...
mmove_t priestess_move_attack1_loop = {FRAME_attackA7, FRAME_attackA12, NULL, priestess_idle, priestess_frames_attack1_loop};
...
mmove_t priestess_move_attack1_end = {FRAME_attackA13, FRAME_attackA16, NULL, priestess_pause, priestess_frames_attack1_end};
...
mmove_t priestess_move_attack2 = {FRAME_attackB1, FRAME_attackB19, NULL, priestess_pause, priestess_frames_attack2};
...
mmove_t priestess_move_pounce_attack = {FRAME_atttrans1, FRAME_attackB17, NULL, priestess_pounce_attack, priestess_frames_pounce_attack};
...
mmove_t priestess_move_backup = {FRAME_backup3, FRAME_backup14, NULL, priestess_pause, priestess_frames_backup};
...
mmove_t priestess_move_death = {FRAME_death1, FRAME_death70, NULL, priestess_dead, priestess_frames_death};
...
mmove_t priestess_move_idle = {FRAME_idle1, FRAME_idle18, NULL, priestess_idle, priestess_frames_idle};
...
mmove_t priestess_move_jump = {FRAME_jump1, FRAME_jump14, NULL, priestess_pause, priestess_frames_jump};
...
mmove_t priestess_move_jump_forward = {FRAME_jump1, FRAME_jump14, NULL, priestess_pause, priestess_frames_jump_forward};
...
mmove_t priestess_move_jump_back = {FRAME_jump1, FRAME_jump14, NULL, priestess_pause, priestess_frames_jump_back};
...
mmove_t priestess_move_jump_right = {FRAME_jump1, FRAME_jump14, NULL, priestess_pause, priestess_frames_jump_right};
...
mmove_t priestess_move_jump_left= {FRAME_jump1, FRAME_jump14, NULL, priestess_pause, priestess_frames_jump_left};
...
mmove_t priestess_move_jump_pounce = {FRAME_jump1, FRAME_jump14, NULL, priestess_pounce_attack, priestess_frames_jump_pounce};
...
mmove_t priestess_move_pain = {FRAME_pain1, FRAME_pain6, NULL, priestess_pause, priestess_frames_pain};
...
mmove_t priestess_move_idle_pose = {FRAME_poseidle1, FRAME_poseidle9, NULL, priestess_idle, priestess_frames_idle_pose};
...
mmove_t priestess_move_pose_trans = {FRAME_pose2ready1, FRAME_pose2ready6, NULL, priestess_idle, priestess_frames_pose_trans};
...
mmove_t priestess_move_shield_go = {FRAME_shield1, FRAME_shield1 + 14, NULL, NULL, priestess_frames_shield_go};
...
mmove_t priestess_move_shield_end = {FRAME_shield1, FRAME_shield8, NULL, priestess_pause, priestess_frames_shield_end};
...
mmove_t priestess_move_dodge_left = {FRAME_sidestplft1, FRAME_sidestplft11, NULL, priestess_pause, priestess_frames_dodge_left};
...
mmove_t priestess_move_dodge_right = {FRAME_sidestprt1, FRAME_sidestprt11, NULL, priestess_pause, priestess_frames_dodge_right};
...
mmove_t priestess_move_walk = {FRAME_walk1, FRAME_walk16, NULL, priestess_pause, priestess_frames_walk};
...
mmove_t priestess_move_attack3_go = {FRAME_attackc1, FRAME_attackc12, NULL, priestess_attack3_loop, priestess_frames_attack3_go};

static mh2frame_t priestess_frames_attack3_loop[] =
{
	{FRAME_attackc13, NULL, 0, 0, 0, NULL, 0, priestess_attack3_loop_fire},
};
mmove_t priestess_move_attack3_loop = {FRAME_attackc13, FRAME_attackc13, NULL, NULL, priestess_frames_attack3_loop};
...
mmove_t priestess_move_attack3_end = {FRAME_attackc14, FRAME_attackc16, NULL, priestess_pause, priestess_frames_attack3_end};
...
mmove_t priestess_move_jump_attack = {FRAME_jumpatt1, FRAME_jumpatt14, NULL, priestess_pause, priestess_frames_jump_attack};
