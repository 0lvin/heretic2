...
extern mmove_t insect_move_land;// = {6, insect_frames_land, insect_pause};
extern mmove_t insect_move_inair;// = {1, insect_frames_inair, NULL};
extern mmove_t insect_move_forcedjump;// = {9, insect_frames_forcedjump, insect_go_inair};
extern mmove_t insect_move_finair;// = {1, insect_frames_inair, NULL};
extern mmove_t insect_move_fjump;// = {9, insect_frames_forcedjump, insect_go_inair};
extern mmove_t insect_move_paina;// = {7, insect_frames_paina, insect_pause};
extern mmove_t insect_move_painc;// = {6, insect_frames_painc, insect_pause};
extern mmove_t insect_move_run;// = {10, insect_frames_run, insect_pause};
extern mmove_t insect_move_spear;// = {11, insect_frames_spear, insect_pause};
extern mmove_t insect_move_sword;// = {9, insect_frames_sword, insect_pause};
extern mmove_t insect_move_spell;// = {8, insect_frames_spell, insect_pause};
extern mmove_t insect_move_spell2;// = {8, insect_frames_spell, insect_pause};
extern mmove_t insect_move_walk;// = {20, insect_frames_walk, insect_pause};
extern mmove_t insect_delay;// = {50 , insect_frames_delay, insect_pause};
...
extern mmove_t insect_move_c_jump;
extern mmove_t insect_move_c_inair;
