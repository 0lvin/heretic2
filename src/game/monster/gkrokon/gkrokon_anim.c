...
static mh2frame_t GkrokonFramesStand1[]=
{
...
mmove_t GkrokonMoveStand1 = {FRAME_bwait1, FRAME_bwait14, NULL, GkrokonPause, GkrokonFramesStand1};

// ****************************************************************************
// Stand2 - Getting up off the floor.
// ****************************************************************************

static mh2frame_t GkrokonFramesStand2[]=
{
...
mmove_t GkrokonMoveStand2 = {FRAME_birth1, FRAME_birth12, NULL, GkrokonPause, GkrokonFramesStand2};

// ****************************************************************************
// Stand3 - Standing fairly still, waiting.
// ****************************************************************************

static mh2frame_t GkrokonFramesStand3[]=
{
...
mmove_t GkrokonMoveStand3 = {FRAME_wait1, FRAME_wait8, NULL, GkrokonPause, GkrokonFramesStand3};

// ****************************************************************************
// Stand4 - Settling down onto the floor.
// ****************************************************************************

static mh2frame_t GkrokonFramesStand4[]=
{
	{FRAME_birth5, NULL, 0, 0, 0, beetle_ai_stand, 0, NULL},
	{FRAME_birth4, NULL, 0, 0, 0, beetle_ai_stand, 0, NULL},
	{FRAME_birth3, NULL, 0, 0, 0, beetle_ai_stand, 0, NULL},
...
mmove_t GkrokonMoveStand4 = {FRAME_birth5, FRAME_birth5 + 4, NULL, GkrokonPause, GkrokonFramesStand4};

// ****************************************************************************
// Crouch1 - Crouched down on the floor (stalking enemy).
// ****************************************************************************

static mh2frame_t GkrokonFramesCrouch1[]=
{
	{FRAME_bwait1, NULL, 0, 0, 0, beetle_ai_stand, 0, NULL},
	{FRAME_bwait2, NULL, 0, 0, 0, beetle_ai_stand, 0, NULL},
	{FRAME_bwait3, NULL, 0, 0, 0, beetle_ai_stand, 0, NULL},
...
mmove_t GkrokonMoveCrouch1 = {FRAME_bwait1, FRAME_bwait14, NULL, GkrokonPause, GkrokonFramesCrouch1};

// ****************************************************************************
// Crouch2 - Getting up off the floor from crouching (stalking enemy).
// ****************************************************************************

static mh2frame_t GkrokonFramesCrouch2[]=
{
...
mmove_t GkrokonMoveCrouch2 = {FRAME_birth1, FRAME_birth4, NULL, beetle_to_stand, GkrokonFramesCrouch2};

// ****************************************************************************
// Crouch3 - Settling down into crouching position (stalking enemy).
// ****************************************************************************

static mh2frame_t GkrokonFramesCrouch3[]=
{
	{FRAME_birth4, NULL, 0, 0, 0, NULL, 0, NULL},
	{FRAME_birth3, NULL, 0, 0, 0, NULL, 0, NULL},
	{FRAME_birth2, NULL, 0, 0, 0, NULL, 0, NULL},
...
mmove_t GkrokonMoveCrouch3 = {FRAME_birth1, FRAME_birth4, NULL, beetle_to_crouch, GkrokonFramesCrouch3};

// ****************************************************************************
// Walk1 - A leisurely ambling gait.
// ****************************************************************************

static mh2frame_t GkrokonFramesWalk1[]=
{
...
mmove_t GkrokonMoveWalk1 = {FRAME_walkB1, FRAME_walkB8, NULL, GkrokonPause, GkrokonFramesWalk1};

// ****************************************************************************
// Run1 - A galloping run.
// ****************************************************************************

static mh2frame_t GkrokonFramesRun1[]=
{
...
mmove_t GkrokonMoveRun1 = {FRAME_gallop1, FRAME_gallop6, NULL, GkrokonPause, GkrokonFramesRun1};

// ****************************************************************************
// Run2 - A skittering, insectlike run.
// ****************************************************************************

static mh2frame_t GkrokonFramesRun2[]=
{
...
mmove_t GkrokonMoveRun2 = {FRAME_skittr1, FRAME_skittr4, NULL, GkrokonPause, GkrokonFramesRun2};

static mh2frame_t GkrokonFramesRunAway[]=
{
...
mmove_t GkrokonMoveRunAway = {FRAME_skittr1, FRAME_skittr1 + 7, NULL, GkrokonPause, GkrokonFramesRunAway};

// ****************************************************************************
// Jump1 - Jumping.
// ****************************************************************************

static mh2frame_t GkrokonFramesJump1[]=
{
...
mmove_t GkrokonMoveJump1 = {FRAME_jump1, FRAME_jump1 + 11, NULL, GkrokonPause, GkrokonFramesJump1};

static mh2frame_t GkrokonFramesForcedJump[]=
{
...
mmove_t GkrokonMoveForcedJump = {FRAME_jump1, FRAME_jump1 + 11, NULL, GkrokonPause, GkrokonFramesForcedJump};

// ****************************************************************************
// GkrokonFramesMeleeAttack1 - A bite attack on my enemy.
// ****************************************************************************
static mh2frame_t GkrokonFramesMeleeAttack1[]=
{
...
mmove_t GkrokonMoveMeleeAttack1 = {FRAME_latack1, FRAME_latack8, NULL, GkrokonPause, GkrokonFramesMeleeAttack1};//GkrokonOrderStand};

static mh2frame_t GkrokonFramesMeleeAttack2[]=
{
...
mmove_t GkrokonMoveMeleeAttack2 = {FRAME_ratack1, FRAME_ratack8, NULL, GkrokonPause, GkrokonFramesMeleeAttack2};

// ****************************************************************************
// GkrokonFramesMissileAttack1 - Firing spoo-goo from spoo launcher.
// ****************************************************************************

static mh2frame_t GkrokonFramesMissileAttack1[]=
{
...
mmove_t GkrokonMoveMissileAttack1 = {FRAME_spoo1, FRAME_spoo5, NULL, GkrokonPause, GkrokonFramesMissileAttack1};

static mh2frame_t GkrokonFramesMissileAttack2[]=
{
	{FRAME_spoo1, NULL, 0, 0, 0, ai_charge, 0, NULL},
	{FRAME_spoo2, NULL, 0, 0, 0, ai_charge, 0, NULL},
	{FRAME_spoo3, NULL, 0, 0, 0, ai_charge, 0, NULL},
...
mmove_t GkrokonMoveMissileAttack2 = {FRAME_spoo1, FRAME_spoo5, NULL, GkrokonPause, GkrokonFramesMissileAttack2};

// ****************************************************************************
// GkrokonFramesEat1 - Going from ready to eating.
// ****************************************************************************

static mh2frame_t GkrokonFramesEat1[]=
{
...
mmove_t GkrokonMoveEat1 = {FRAME_eat1, FRAME_eat4, NULL, GkrokonPause, GkrokonFramesEat1};

// ****************************************************************************
// GkrokonFramesEat2 - The eat cycle.
// ****************************************************************************

static mh2frame_t GkrokonFramesEat2[]=
{
...
mmove_t GkrokonMoveEat2 = {FRAME_eat5, FRAME_eat9, NULL, GkrokonPause, GkrokonFramesEat2};

// ****************************************************************************
// GkrokonFramesEat3 - Going from eating to ready.
// ****************************************************************************

static mh2frame_t GkrokonFramesEat3[]=
{
...
mmove_t GkrokonMoveEat3 = {FRAME_EATTRANS1, FRAME_EATTRANS4, NULL, GkrokonPause, GkrokonFramesEat3};

// ****************************************************************************
// Pain1 -
// ****************************************************************************

static mh2frame_t GkrokonFramesPain1[]=
{
...
mmove_t GkrokonMovePain1 = {FRAME_pain1, FRAME_pain8, NULL, GkrokonPause, GkrokonFramesPain1};

// ****************************************************************************
// Death1 -
// ****************************************************************************

static mh2frame_t GkrokonFramesDeath1[]=
{
...
mmove_t GkrokonMoveDeath1 = {FRAME_death1, FRAME_death26, NULL, GkrokonDead, GkrokonFramesDeath1};

static mh2frame_t GkrokonStartHop[]=
{
...
mmove_t GkrokonMoveHop1 = {FRAME_birth5, FRAME_birth12, NULL, GkrokonPause, GkrokonStartHop};

static mh2frame_t GkrokonFramesDelay[]=
{
...
mmove_t GkrokonMoveDelay = {FRAME_bwait1, FRAME_bwait14, NULL, GkrokonPause, GkrokonFramesDelay};
