...
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_daggerl [] =
{
...
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_daggerr [] =
{
...
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_daggerb [] =
{
...
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_daggerc [] =
{
...
static animframe_t assassin_frames_newdagger [] =
{
...
static animframe_t assassin_frames_newdaggerb [] =
{
...
/*----------------------------------------------------------------------
  assassin crouch
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_crouch [] =
{
...
/*----------------------------------------------------------------------
  assassin uncrouch
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_uncrouch [] =
{
...
/*----------------------------------------------------------------------
  assassin in air
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_evinair [] =
{
...
/*----------------------------------------------------------------------
  assassin in air
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_inair [] =
{
...
/*----------------------------------------------------------------------
  assassin land
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_land [] =
{
...
/*----------------------------------------------------------------------
  assassin jump
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_evade_jump [] =
{
...
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_evade_backflip [] =
{
...
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_evade_frontflip [] =
{
...
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_dodge_right [] =
{
...
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_dodge_left [] =
{
...
/*----------------------------------------------------------------------
  assassin DeathA
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_deatha [] =
{
...
/*-------------------------------------------------------------------------
	assassin Death B
-------------------------------------------------------------------------*/
static animframe_t assassin_frames_deathb [] =
{
...
/*----------------------------------------------------------------------
  assassin jump
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_jump [] =
{
...
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_forcedjump [] =
{
	{FRAME_jump1,	NULL, 0, 0, 0, ai_charge, 0, NULL},
	{FRAME_jump2,	NULL, 0, 0, 0, ai_charge, 0, NULL},
	{FRAME_jump3,	NULL, 0, 0, 0, ai_charge, 0, NULL},
...
/*----------------------------------------------------------------------
  assassin forced jump
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_fjump [] =
{
	{FRAME_jump1,	NULL, 0, 0, 0, ai_charge, 0, NULL},
	{FRAME_jump2,	NULL, 0, 0, 0, ai_charge, 0, NULL},
	{FRAME_jump3,	NULL, 0, 0, 0, ai_charge, 0, NULL},
...
/*----------------------------------------------------------------------
  assassin backflipping
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_bfland [] =
{
...
/*----------------------------------------------------------------------
  assassin backflipping
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_bfinair [] =
{
...
/*----------------------------------------------------------------------
  assassin backflipping
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_backflip [] =
{
...
static animframe_t assassin_frames_backspring [] =
{
...
/*----------------------------------------------------------------------
  assassin front flipping
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_ffland [] =
{
...
/*----------------------------------------------------------------------
  assassin front flipping
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_ffinair [] =
{
	{FRAME_fntflp11, NULL, 0, 0, 0, MG_CheckLanded, ANIM_FFLAND, NULL},
};
...
/*----------------------------------------------------------------------
  assassin front flipping
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_frontflip [] =
{
...
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_run [] =
...
static animframe_t assassin_frames_walk [] =
{
...
static animframe_t assassin_frames_walk_loop [] =
{
...
static animframe_t assassin_frames_pain1 [] =
{
...
/*----------------------------------------------------------------------
  assassin Pain - assassin gets hit
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_pain2 [] =
{
...
static animframe_t assassin_frames_stand [] =
{
...
static animframe_t assassin_frames_delay [] =
{
...
static animframe_t assassin_frames_crouch_trans [] =
{
...
static animframe_t assassin_frames_crouch_idle [] =
{
...
static animframe_t assassin_frames_crouch_look_right[] =
{
...
static animframe_t assassin_frames_crouch_look_right_idle[] =
{
...
static animframe_t assassin_frames_crouch_look_l2r[] =
{
...
static animframe_t assassin_frames_crouch_look_left[] =
{
...
static animframe_t assassin_frames_crouch_look_left_idle[] =
{
...
static animframe_t assassin_frames_crouch_look_r2l[] =
{
...
static animframe_t assassin_frames_crouch_look_r2c[] =
{
...
static animframe_t assassin_frames_crouch_look_l2c[] =
{
...
static animframe_t assassin_frames_crouch_end[] =
{
	{FRAME_newcrchtrn5, NULL, 0, 0, 0, NULL, 0, NULL},
	{FRAME_newcrchtrn4, NULL, 0, 0, 0, NULL, 0, NULL},
	{FRAME_newcrchtrn3, NULL, 0, 0, 0, NULL, 0, NULL},
...
static animframe_t assassin_frames_crouch_poke[] =
{
...
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_teleport [] =
{
...
static animframe_t assassin_frames_cloak [] =
{
	{FRAME_jump14,	NULL, 0, 0, 0, NULL, 0, assassinSetCrouched},
	{FRAME_jump15,	NULL, 0, 0, 0, NULL, 0, NULL},
...
static animframe_t assassin_frames_c_idle1 [] =
{
...
/*----------------------------------------------------------------------
  assassin Running - assassin running
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_c_run1 [] =
{
...
/*----------------------------------------------------------------------
  assassin daggerL - assassin attacking left hand
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_c_attack1 [] =
{
	{FRAME_ataka1,	ai_c_move, 0, 0, 0, NULL, 0, NULL},
	{FRAME_ataka2,	ai_c_move, 0, 0, 0, NULL, 0, NULL},
	{FRAME_ataka3,	ai_c_move, 0, 0, 0, NULL, 0, NULL},
...
/*----------------------------------------------------------------------
  assassin daggerR - assassin attacking right hand
-----------------------------------------------------------------------*/
static animframe_t assassin_frames_c_attack2 [] =
{
