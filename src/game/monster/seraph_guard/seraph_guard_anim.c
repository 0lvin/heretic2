...
mmove_t seraph_guard_move_stand = {FRAME_idle1, FRAME_idle29, NULL, seraph_guard_pause, seraph_guard_frames_stand};
...
mmove_t seraph_guard_move_melee = {FRAME_axea1, FRAME_axea1 + 21, NULL, seraph_guard_pause, seraph_guard_frames_melee};
...
mmove_t seraph_guard_move_pain = {FRAME_pain1, FRAME_pain5, NULL, seraph_guard_pause, seraph_guard_frames_pain};
...
mmove_t seraph_guard_move_runmelee = {FRAME_runaxe4, FRAME_runaxe4 + 7, NULL, seraph_guard_pause, seraph_guard_frames_runmelee};
...
mmove_t seraph_guard_move_run = {FRAME_run1, FRAME_run8, NULL, seraph_guard_pause, seraph_guard_frames_run};
...
mmove_t seraph_guard_move_fjump = {FRAME_run1, FRAME_run8, NULL, seraph_guard_pause, seraph_guard_frames_fjump};
...
mmove_t seraph_guard_move_walk = {FRAME_walk1, FRAME_walk16, NULL, seraph_guard_pause, seraph_guard_frames_walk};
...
mmove_t seraph_guard_move_melee2 = {FRAME_axeb1, FRAME_axeb1 + 11, NULL, seraph_guard_pause, seraph_guard_frames_melee2};
...
mmove_t seraph_guard_move_melee3 = {FRAME_axec1, FRAME_axec1 + 15, NULL, seraph_guard_pause, seraph_guard_frames_melee3};
...
mmove_t seraph_guard_move_death1 = {FRAME_deatha1, FRAME_deatha24, NULL, NULL, seraph_guard_frames_death1};
...
mmove_t seraph_guard_move_death2_go = {FRAME_deathb1, FRAME_deathb4, NULL, seraph_guard_death_loop, seraph_guard_frames_death2_go};

static mh2frame_t seraph_guard_frames_death2_loop[] =
{
	{FRAME_deathb5, NULL, 0, 0, 0, NULL, 0, seraph_guard_check_land},
};
mmove_t seraph_guard_move_death2_loop = {FRAME_deathb5, FRAME_deathb5, NULL, NULL, seraph_guard_frames_death2_loop};
...
mmove_t seraph_guard_move_death2_end = {FRAME_deathb6, FRAME_deathb15, NULL, NULL, seraph_guard_frames_death2_end};
...
mmove_t seraph_guard_move_backup = {FRAME_backup1, FRAME_backup16, NULL, seraph_guard_pause, seraph_guard_frames_backup};
...
mmove_t seraph_guard_move_missile = {FRAME_newshot1, FRAME_newshot11, NULL, seraph_guard_pause, seraph_guard_frames_missile};
...
mmove_t seraph_guard_move_delay = {FRAME_idle1, FRAME_idle29, NULL, seraph_guard_pause, seraph_guard_frames_delay};
