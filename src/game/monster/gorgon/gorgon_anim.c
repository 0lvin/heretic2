...
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_stand3 [] =
{
...
animmove_t gorgon_move_stand3 = {5, gorgon_frames_stand3, gorgon_mood};

/*----------------------------------------------------------------------
	STAND2 -   Gorgon Standing and looking left
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_stand2 [] =
{
...
animmove_t gorgon_move_stand2 = {5, gorgon_frames_stand2, gorgon_mood};


/*----------------------------------------------------------------------
	STAND1 -   Gorgon Standing and wagging it's tail
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_stand1 [] =
{
...
animmove_t gorgon_move_stand1 = {8, gorgon_frames_stand1, gorgon_mood};

/*----------------------------------------------------------------------
	STAND1 -   Gorgon Standing and wagging it's tail
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_stand4 [] =
{
	{FRAME_wait1,	NULL, 0, 0, 0, ai_stand, 0, NULL},
	{FRAME_wait2,	NULL, 0, 0, 0, ai_stand, 0, NULL},
	{FRAME_wait3,	NULL, 0, 0, 0, ai_stand, 0, NULL},
...
animmove_t gorgon_move_stand4 = {8, gorgon_frames_stand4, gorgon_mood};

/*----------------------------------------------------------------------
  Gorgon Turning right while running
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_walk3 [] =
{
...
animmove_t gorgon_move_walk3 = {12, gorgon_frames_walk3, gorgon_mood};


/*----------------------------------------------------------------------
  Gorgon Turning left while running
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_walk2 [] =
{
...
animmove_t gorgon_move_walk2 = {12, gorgon_frames_walk2, gorgon_mood};

/*----------------------------------------------------------------------
  Gorgon Walking
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_walk [] =
{
...
animmove_t gorgon_move_walk = {12, gorgon_frames_walk, gorgon_mood};
...
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_fjump [] =
{
...
/*----------------------------------------------------------------------
	land 1
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_land [] =
{
...
animmove_t gorgon_move_land = {3, gorgon_frames_land, gorgon_mood};

/*----------------------------------------------------------------------
	land 2
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_land2 [] =
{
	{FRAME_jumpa15,NULL, 0, 0, 0, NULL, 0,  gorgon_land},
	{FRAME_jumpa16,NULL, 0, 0, 0, NULL, 0,  gorgon_growl},
	{FRAME_jumpa17,NULL, 0, 0, 0, NULL, 0,  NULL},
};
animmove_t gorgon_move_land2 = {3, gorgon_frames_land2, gorgon_mood};

/*----------------------------------------------------------------------
	in air
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_inair [] =
{
...
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_melee10 [] =
{
...
/*----------------------------------------------------------------------
	MELEE9 - hop backward
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_melee9 [] =
{
...
animmove_t gorgon_move_melee9 = {10, gorgon_frames_melee9, gorgon_mood};

/*----------------------------------------------------------------------
	MELEE8 - hop forward
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_melee8 [] =
{
	{FRAME_hop1,  NULL, 0, 0, 0, ai_goal_charge, 0,  NULL},
	{FRAME_hop2,  NULL, 0, 0, 0, ai_goal_charge, 0,  NULL},
	{FRAME_hop3,  NULL, 0, 0, 0, ai_goal_charge, 0,  NULL},
...
animmove_t gorgon_move_melee8 = {10, gorgon_frames_melee8, gorgon_mood};

/*----------------------------------------------------------------------
  MELEE7 - hop right
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_melee7 [] =
{
	{FRAME_hop1,  NULL, 0, 0, 0, ai_goal_charge, 0,  NULL},
	{FRAME_hop2,  NULL, 0, 0, 0, ai_goal_charge, 0,  NULL},
	{FRAME_hop3,  NULL, 0, 0, 0, ai_goal_charge, 0,  NULL},
...
animmove_t gorgon_move_melee7 = {10, gorgon_frames_melee7, gorgon_mood};

/*----------------------------------------------------------------------
  MELEE6 - hop left
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_melee6 [] =
{
	{FRAME_hop1,  NULL, 0, 0, 0, ai_goal_charge, 0,  NULL},
	{FRAME_hop2,  NULL, 0, 0, 0, ai_goal_charge, 0,  NULL},
	{FRAME_hop3,  NULL, 0, 0, 0, ai_goal_charge, 0,  NULL},
...
animmove_t gorgon_move_melee6 = {10, gorgon_frames_melee6, gorgon_mood};


/*----------------------------------------------------------------------
  Melee5 -  running attack
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_melee5 [] =
{
...
animmove_t gorgon_move_melee5 = {8, gorgon_frames_melee5, gorgon_mood};


/*----------------------------------------------------------------------
   Melee4 -   Gorgon Attack Pullback
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_melee4 [] =
{
...
animmove_t gorgon_move_melee4 = {4, gorgon_frames_melee4, gorgon_mood};


/*----------------------------------------------------------------------
   Melee3 -   Gorgon Attack Up
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_melee3 [] =
{
...
animmove_t gorgon_move_melee3 = {4, gorgon_frames_melee3, gorgon_mood};


/*----------------------------------------------------------------------
   Melee2 -   Gorgon Attack Right
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_melee2 [] =
{
...
animmove_t gorgon_move_melee2 = {4, gorgon_frames_melee2, gorgon_mood};


/*----------------------------------------------------------------------
   Melee1 -   Gorgon Attack Left
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_melee1 [] =
{
...
animmove_t gorgon_move_melee1 = {4, gorgon_frames_melee1, gorgon_mood};


/*----------------------------------------------------------------------
  RUN3 - Turning right while running
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_run3 [] =
{
...
animmove_t gorgon_move_run3 = {12, gorgon_frames_run3, gorgon_mood};


/*----------------------------------------------------------------------
  RUN2 - Turning left while running
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_run2 [] =
{
...
animmove_t gorgon_move_run2 = {12, gorgon_frames_run2, gorgon_mood};
...
/*----------------------------------------------------------------------
  Gorgon Running
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_run1 [] =
{
...
animmove_t gorgon_move_run1 = {8, gorgon_frames_run1, gorgon_mood};

/*----------------------------------------------------------------------
  Gorgon Pain1 - step back while bending head down
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_pain1 [] =
{
...
animmove_t gorgon_move_pain1 = {9, gorgon_frames_pain1, gorgon_mood};


/*----------------------------------------------------------------------
  Gorgon Pain2 - bend head to the left
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_pain2 [] =
{
...
animmove_t gorgon_move_pain2 = {5, gorgon_frames_pain2, gorgon_mood};

/*----------------------------------------------------------------------
  Gorgon Pain3 - bend head to the right
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_pain3 [] =
{
...
animmove_t gorgon_move_pain3 = {5, gorgon_frames_pain3, gorgon_mood};
...
static animframe_t gorgon_frames_die1 [] =
{
...
static animframe_t gorgon_frames_death2slide [] =
{
...
static animframe_t gorgon_frames_die2 [] =
{
...
/*----------------------------------------------------------------------
   Melee3 -   Gorgon Attack Up
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_catch [] =
{
...
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_miss [] =
{
...
animmove_t gorgon_move_miss = {4, gorgon_frames_miss, gorgon_mood};
...
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_snatch [] =
{
...
/*----------------------------------------------------------------------
  Gorgon Eat3 - pull back, then bend back down to eat
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_readycatch [] =
{
	{FRAME_jumpb4, NULL, 0, 0, 0, NULL, 0,  NULL},
};
...
/*----------------------------------------------------------------------
  Gorgon
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_snatchhi [] =
{
...
/*----------------------------------------------------------------------
  Gorgon
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_snatchlow [] =
{
...
?
-----------------------*/
static animframe_t gorgon_frames_slip [] =
{
...
animmove_t gorgon_move_slip = {36, gorgon_frames_slip, gorgon_mood};

/*----------------
?
-----------------------*/
static animframe_t gorgon_frames_slip_pain [] =
{
...
animmove_t gorgon_move_slip_pain = {26, gorgon_frames_slip_pain, gorgon_mood};

/*----------------------------------------------------------------------
	delay
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_delay [] =
{
...
animmove_t gorgon_move_delay = {8, gorgon_frames_delay, gorgon_mood};

/*----------------------------------------------------------------------
  Gorgon roar- make noise, alert others
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_roar [] =
{
...
animmove_t gorgon_move_roar = {19, gorgon_frames_roar, gorgon_mood};

/*----------------------------------------------------------------------
  Gorgon roar2- make noise in response to main roar
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_roar2 [] =
{
...
animmove_t gorgon_move_roar2 = {19, gorgon_frames_roar2, gorgon_mood};
...
/*----------------------------------------------------------------------
  Gorgon Swimming
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_to_swim [] =
...
static animframe_t gorgon_frames_swim [] =
{ //FIXME: add wake and bubbles and sploosh swim sounds
...
static animframe_t gorgon_frames_swim_bite_a [] =
{ //FIXME: add wake and bubbles and sploosh swim sounds
...
static animframe_t gorgon_frames_swim_bite_b [] =
{ //FIXME: add wake and bubbles and sploosh swim sounds
...
static animframe_t gorgon_frames_outwater [] =
{ //FIXME: add wake and bubbles and sploosh swim sounds
...
animmove_t gorgon_move_outwater = {20, gorgon_frames_outwater, gorgon_mood};
...
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_eat_down [] =
{
...
/*----------------------------------------------------------------------
	eating trans to up
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_eat_up [] =
{
...
/*----------------------------------------------------------------------
  eat cycle
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_eat_loop [] =
{
...
/*----------------------------------------------------------------------
  eating - tear
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_eat_tear [] =
{
...
/*----------------------------------------------------------------------
  eat- up & down
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_eat_pullback [] =
{
	{FRAME_eatinga5, NULL, 0, 0, 0, gorgon_ai_eat, 0,  NULL},
	{FRAME_eatinga4, NULL, 0, 0, 0, gorgon_ai_eat, 0,  NULL},
	{FRAME_eatinga3, NULL, 0, 0, 0, gorgon_ai_eat, 0,  NULL},
...
/*----------------------------------------------------------------------
	look around
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_look_around [] =
...
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_eat_left [] =
{
...
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_eat_right [] =
{
...
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_eat_snap [] =
{
...
-----------------------------------------------------------------------*/
static animframe_t gorgon_frames_eat_react [] =
{
