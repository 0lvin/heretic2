...
mmove_t chicken_move_stand1 = {FRAME_wait1, FRAME_wait6, chicken_frames_stand1, chicken_pause};
...
mmove_t chicken_move_run = {FRAME_run1, FRAME_run6, chicken_frames_run, chicken_pause};
...
mmove_t chicken_move_walk = {FRAME_walk1, FRAME_walk8, chicken_frames_walk, chicken_pause};
...
mmove_t chicken_move_cluck = {FRAME_cluck1, FRAME_cluck19, chicken_frames_cluck, chicken_eat_again};
...
mmove_t chicken_move_attack = {FRAME_attack1, FRAME_attack6, chicken_frames_attack, chicken_pause};
...
mmove_t chicken_move_eat = {FRAME_peck1, FRAME_peck29, chicken_frames_eat, chicken_eat_again};
...
mmove_t chicken_move_jump = {FRAME_jump1, FRAME_jump6, chicken_frames_jump, chicken_pause};
