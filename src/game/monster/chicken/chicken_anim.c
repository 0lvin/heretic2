...
mmove_t chicken_move_stand1 = {FRAME_wait1, FRAME_wait6, NULL, chicken_pause, chicken_frames_stand1};
...
mmove_t chicken_move_run = {FRAME_run1, FRAME_run6, NULL, chicken_pause, chicken_frames_run};
...
mmove_t chicken_move_walk = {FRAME_walk1, FRAME_walk8, NULL, chicken_pause, chicken_frames_walk};
...
mmove_t chicken_move_cluck = {FRAME_cluck1, FRAME_cluck19, NULL, chicken_eat_again, chicken_frames_cluck};
...
mmove_t chicken_move_attack = {FRAME_attack1, FRAME_attack6, NULL, chicken_pause, chicken_frames_attack};
...
mmove_t chicken_move_eat = {FRAME_peck1, FRAME_peck29, NULL, chicken_eat_again, chicken_frames_eat};
...
mmove_t chicken_move_jump = {FRAME_jump1, FRAME_jump6, NULL, chicken_pause, chicken_frames_jump};
