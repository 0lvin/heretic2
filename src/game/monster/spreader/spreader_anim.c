...
mmove_t spreader_move_attack1 = { 16, spreader_frames_attack1, spreader_pause };
...
mmove_t spreader_move_attack2 = { 14, spreader_frames_attack2, spreader_pause };
...
mmove_t spreader_move_backattack1 = { 13, spreader_frames_backattack1, spreader_pause };
...
mmove_t spreader_move_backup1 = { 13, spreader_frames_backup1, spreader_pause };
...
mmove_t spreader_move_death1_go = { 1, spreader_frames_death1_go, spreader_flyback_loop };

static mframe_t spreader_frames_death1_loop [] =
{
	{FRAME_death2, NULL, 0, 0, 0, NULL, 0, spreader_flyback_move},
};
mmove_t spreader_move_death1_loop = { 1, spreader_frames_death1_loop, NULL };
...
mmove_t spreader_move_death1_end = { 15, spreader_frames_death1_end, NULL };
...
mmove_t spreader_move_death2 = { 14, spreader_frames_death2, NULL };
...
mmove_t spreader_move_dkatck1 = { 6, spreader_frames_dkatck1, spreader_pause };
...
mmove_t spreader_move_duck1 = { 7, spreader_frames_duck1, spreader_pause };
...
mmove_t spreader_move_duckdown = { 4, spreader_frames_duckdown, spreader_duckpause };
...
mmove_t spreader_move_duckstill = { 12, spreader_frames_duckstill, spreader_duckpause };
...
mmove_t spreader_move_duckup = { 4, spreader_frames_duckup, spreader_pause };
...
mmove_t spreader_move_idle1 = { 11, spreader_frames_idle1, spreader_pause };
...
mmove_t spreader_move_pain1 = { 7, spreader_frames_pain1, spreader_pause };
...
mmove_t spreader_move_pvtlt1 = { 5, spreader_frames_pvtlt1, spreader_pause };
...
mmove_t spreader_move_pvtrt1 = { 5, spreader_frames_pvtrt1, spreader_pause };
...
mmove_t spreader_move_run1 = { 8, spreader_frames_run1, spreader_pause };
...
mmove_t spreader_move_land = {7, spreader_frames_land, spreader_pause};
...
mmove_t spreader_move_inair = {1, spreader_frames_inair, NULL};
...
mmove_t spreader_move_fjump = {15, spreader_frames_fjump, spreader_go_inair};
...
mmove_t spreader_move_rnatck1 = { 8, spreader_frames_rnatck1, spreader_pause };
...
mmove_t spreader_move_walk1 = { 13, spreader_frames_walk1, spreader_pause };
...
mmove_t spreader_move_walk2 = { 13, spreader_frames_walk2, spreader_pause };
...
mmove_t spreader_move_flyloop = { 1, spreader_frames_flyloop, NULL};
...
mmove_t spreader_move_fly = { 4, spreader_frames_fly, spreaderFlyLoop};
...
mmove_t spreader_move_dead = { 1, spreader_frames_dead, NULL};
...
mmove_t spreader_move_fdie = { 14, spreader_frames_fdie, spreader_go_deadloop};
...
mmove_t spreader_move_delay = { 11, spreader_frames_delay, spreader_pause };
