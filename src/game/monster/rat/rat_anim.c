...
-----------------------------------------------------------------------*/
static mh2frame_t rat_frames_death2 [] =
{
...
mmove_t rat_move_death2 = {FRAME_DeathB1, FRAME_DeathB9, NULL, M_EndDeath, rat_frames_death2};

/*----------------------------------------------------------------------
  Rat Death 1 - the big death, flying backwards and flipping over
-----------------------------------------------------------------------*/
static mh2frame_t rat_frames_death1 [] =
{
...
mmove_t rat_move_death1 = {FRAME_deathA1, FRAME_deathA14, NULL, M_EndDeath, rat_frames_death1};

/*----------------------------------------------------------------------
  Rat Pain - backup and run away
-----------------------------------------------------------------------*/
static mh2frame_t rat_frames_pain1 [] =
{
...
mmove_t rat_move_pain1 = {FRAME_backup1, FRAME_backup6, NULL, rat_pause, rat_frames_pain1};

/*----------------------------------------------------------------------
  Rat Melee - rat attacking at feet
-----------------------------------------------------------------------*/
static mh2frame_t rat_frames_melee1 [] =
{
...
mmove_t rat_move_melee1 = {FRAME_eat1, FRAME_eat5, NULL, rat_pause, rat_frames_melee1};

/*----------------------------------------------------------------------
  Rat Melee - rat attacking jumping in the air
-----------------------------------------------------------------------*/
static mh2frame_t rat_frames_melee2 [] =
{
...
mmove_t rat_move_melee2 = {FRAME_attack1, FRAME_attack11, NULL, rat_pause, rat_frames_melee2};

/*----------------------------------------------------------------------
  Rat Melee - rat attacking 2
-----------------------------------------------------------------------*/
static mh2frame_t rat_frames_melee3 [] =
{
...
mmove_t rat_move_melee3 = {FRAME_eat12, FRAME_eat24, NULL, rat_pause, rat_frames_melee3};

/*----------------------------------------------------------------------
  Rat Running - rat running to the right
-----------------------------------------------------------------------*/
static mh2frame_t rat_frames_run3 [] =
{
...
mmove_t rat_move_run3 = {FRAME_run_rt1, FRAME_run_rt4, NULL, NULL, rat_frames_run3};

/*----------------------------------------------------------------------
  Rat Running - rat running to the left
-----------------------------------------------------------------------*/
static mh2frame_t rat_frames_run2 [] =
{
...
mmove_t rat_move_run2 = {FRAME_run_lft1, FRAME_run_lft4, NULL, rat_runorder, rat_frames_run2};

/*----------------------------------------------------------------------
  Rat Running - rat running
-----------------------------------------------------------------------*/
static mh2frame_t rat_frames_run1 [] =
{
...
mmove_t rat_move_run1 = {FRAME_run1, FRAME_run5, NULL, rat_runorder, rat_frames_run1};

/*----------------------------------------------------------------------
  Rat Walking - rat walking
-----------------------------------------------------------------------*/
static mh2frame_t rat_frames_walk1 [] =
{
...
mmove_t rat_move_walk1 = {FRAME_walk1, FRAME_walk6, NULL, NULL, rat_frames_walk1};

/*----------------------------------------------------------------------
  Rat Stand8 - from haunches, dropping down to ground
-----------------------------------------------------------------------*/

static mh2frame_t rat_frames_stand8 [] =
{
...
mmove_t rat_move_stand8 = {FRAME_haunch44, FRAME_haunch49, NULL, rat_standorder, rat_frames_stand8};

/*----------------------------------------------------------------------
  Rat Stand7 - sitting on haunches, scratch right
-----------------------------------------------------------------------*/
static mh2frame_t rat_frames_stand7 [] =
{
...
mmove_t rat_move_stand7 = {FRAME_haunch38, FRAME_haunch42, NULL, rat_standorder, rat_frames_stand7};

/*----------------------------------------------------------------------
  Rat Stand6 - sitting on haunches, scratch left
-----------------------------------------------------------------------*/
static mh2frame_t rat_frames_stand6 [] =
{
...
mmove_t rat_move_stand6 = {FRAME_haunch32, FRAME_haunch36, NULL, rat_standorder, rat_frames_stand6};

/*----------------------------------------------------------------------
  Rat Stand5 - sitting on haunches, look right
-----------------------------------------------------------------------*/
static mh2frame_t rat_frames_stand5 [] =
{
...
mmove_t rat_move_stand5 = {FRAME_haunch26, FRAME_haunch30, NULL, rat_standorder, rat_frames_stand5};

/*----------------------------------------------------------------------
  Rat Stand4 - sitting on haunches, looking left
-----------------------------------------------------------------------*/
static mh2frame_t rat_frames_stand4 [] =
{
...
mmove_t rat_move_stand4 = {FRAME_haunch20, FRAME_haunch24, NULL, rat_standorder, rat_frames_stand4};

/*----------------------------------------------------------------------
  Rat Stand3 - sitting on haunches
-----------------------------------------------------------------------*/
static mh2frame_t rat_frames_stand3 [] =
{
...
mmove_t rat_move_stand3 = {FRAME_haunch12, FRAME_haunch18, NULL, rat_standorder, rat_frames_stand3};

/*----------------------------------------------------------------------
  Rat Stand2 - rising up to sit on haunches
-----------------------------------------------------------------------*/
static mh2frame_t rat_frames_stand2 [] =
{
...
mmove_t rat_move_stand2 = {FRAME_haunch1, FRAME_haunch10, NULL, rat_standorder, rat_frames_stand2};

/*----------------------------------------------------------------------
  Rat Standing -
-----------------------------------------------------------------------*/
static mh2frame_t rat_frames_stand1 [] =
{
...
mmove_t rat_move_stand1 = {FRAME_idle1, FRAME_idle8, NULL, rat_standorder, rat_frames_stand1};

/*----------------------------------------------------------------------
  Rat Watch2 - Stand up and hiss then go back to all fours
-----------------------------------------------------------------------*/
static mh2frame_t rat_frames_watch2 [] =
{
...
mmove_t rat_move_watch2 = {FRAME_hiss1, FRAME_hiss13, NULL, rat_eatorder, rat_frames_watch2};

/*----------------------------------------------------------------------
  Rat Hiss 1 - Hiss while on all fours
-----------------------------------------------------------------------*/
static mh2frame_t rat_frames_watch1 [] =
{
...
mmove_t rat_move_watch1 = {FRAME_hiss14, FRAME_hiss29, NULL, rat_eatorder, rat_frames_watch1};

/*----------------------------------------------------------------------
  Rat Eat3 - Bite and pull back a little
-----------------------------------------------------------------------*/
static mh2frame_t rat_frames_eat3 [] =
{
...
mmove_t rat_move_eat3 = {FRAME_eat9, FRAME_eat12, NULL, rat_eatorder, rat_frames_eat3};

/*----------------------------------------------------------------------
  Rat Eat2 - Bite low and tear up
-----------------------------------------------------------------------*/
static mh2frame_t rat_frames_eat2 [] =
{
...
mmove_t rat_move_eat2 = {FRAME_eat12, FRAME_eat24, NULL, rat_eatorder, rat_frames_eat2};

/*----------------------------------------------------------------------
  Rat Eat1 - Bite down low
-----------------------------------------------------------------------*/
static mh2frame_t rat_frames_eat1 [] =
{
...
mmove_t rat_move_eat1 = {FRAME_eat1, FRAME_eat9, NULL, rat_eatorder, rat_frames_eat1};
