...
{"rotate", STOFS(rotate), F_INT},
{"zangle", STOFS(zangle), F_FLOAT},
{"file", STOFS(file), F_LSTRING},
{"radius", STOFS(radius), F_INT},
{"offensive", STOFS(offensive), F_INT},
{"defensive", STOFS(defensive), F_INT},
{"spawnflags2", STOFS(spawnflags2), F_INT},
{"cooptimeout", STOFS(cooptimeout), F_INT},
{"script", STOFS(script), F_LSTRING},
{"parm1", STOFS(parms[0]), F_LSTRING},
{"parm2", STOFS(parms[1]), F_LSTRING},
{"parm3", STOFS(parms[2]), F_LSTRING},
{"parm4", STOFS(parms[3]), F_LSTRING},
{"parm5", STOFS(parms[4]), F_LSTRING},
{"parm6", STOFS(parms[5]), F_LSTRING},
{"parm7", STOFS(parms[6]), F_LSTRING},
{"parm8", STOFS(parms[7]), F_LSTRING},
{"parm9", STOFS(parms[8]), F_LSTRING},
{"parm10", STOFS(parms[9]), F_LSTRING},
