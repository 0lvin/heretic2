...
extern void DamageField_Touch (edict_t *self, edict_t *other, cplane_t *plane, csurface_t *surf) ;
...
extern void biotank_touch (edict_t *self, edict_t *other, cplane_t *plane, csurface_t *surf) ;
...
extern void bush_touch (edict_t *self, edict_t *other, cplane_t *plane, csurface_t *surf) ;
...
extern void cactus_touch (edict_t *self, edict_t *other, cplane_t *plane, csurface_t *surf) ;
...
extern void choose_cdtrack_touch ( edict_t *self, edict_t *other, cplane_t *plane , csurface_t *surf ) ;
...
extern void destructible_die ( edict_t * self ,  edict_t * inflictor , edict_t * attacker , int damage, vec3_t point);
...
extern void dying_elf_die (edict_t *self, edict_t *inflictor, edict_t *attacker, int damage, vec3_t point) ;
...
extern void fire_touch (edict_t *self, edict_t *other, cplane_t *plane, csurface_t *surf);
...
extern void ironmaiden_touch (edict_t *self, edict_t *other, cplane_t *plane, csurface_t *surf) ;
extern void ironmaiden_touch (edict_t *self, edict_t *other, cplane_t *plane, csurface_t *surf);
...
extern void larva_touch (edict_t *self, edict_t *other, cplane_t *plane, csurface_t *surf) ;
...
extern void misc_magic_portal_touch(edict_t *self, edict_t *other, cplane_t *plane, csurface_t *surf);
...
extern void monster_dynamic_die ( edict_t *self, edict_t *inflictor, edict_t *attacker, int damage, vec3_t point ) ;
extern void monster_dynamic_die_noanim ( edict_t *self, edict_t *inflictor, edict_t *attacker, int damage, vec3_t point ) ;
...
extern void objpush_touch (edict_t *self, edict_t *other, cplane_t *plane, csurface_t *surf) ;
...
extern void rope_touch (edict_t *self, edict_t *other, cplane_t *plane, csurface_t *surf);
...
extern void rotfish_die ( edict_t * self ,  edict_t * inflictor , edict_t * attacker , int damage, vec3_t point ) ;
...
extern void shrine_armor_silver_touch ( edict_t *self, edict_t *other, cplane_t *plane, csurface_t *surf ) ;
...
extern void trigger_playerpushbutton(edict_t *self, edict_t *other, cplane_t *plane, csurface_t *surface);
