...
extern edict_t * PickCoopTarget ( const edict_t * self ) ;
...
extern int DBall_ChangeDamage ( const edict_t * targ , const edict_t * attacker , int damage , int mod ) ;
extern int DBall_ChangeKnockback ( const edict_t * targ , const edict_t * attacker , int knockback , int mod ) ;
extern int PowerArmorType ( const edict_t * ent ) ;
extern int Tag_ChangeDamage ( const edict_t * targ , const edict_t * attacker , int damage , int mod ) ;
...
extern qboolean MarkTeslaArea ( const edict_t * self , edict_t * tesla ) ;
...
extern qboolean has_valid_enemy ( const edict_t * self ) ;
...
extern qboolean monster_jump_finished ( const edict_t * self ) ;
...
extern void BboxYawAndScaleAndMoveUp(edict_t *self) ;
...
extern void DamageField_Touch (edict_t *self, edict_t *other, const cplane_t * plane , const csurface_t * surf ) ;
extern void DamageField_Use ( edict_t *self, edict_t *other, edict_t *activator );
...
extern void ItemSpitterSpit(edict_t *self,edict_t *owner,edict_t *attacker);
...
extern void M_Touch(edict_t *self, edict_t *other, const cplane_t * plane , const csurface_t * surf ) ;
...
extern void Tag_DogTag ( const edict_t * ent , edict_t * killer , char * * pic ) ;
extern void Tag_DropToken ( edict_t * ent , const gitem_t * item ) ;
...
extern void Tag_Score ( edict_t * attacker , const edict_t * victim , int scoreChange ) ;
...
extern void ThrowGibACID ( edict_t * self , const char * gibname , int damage , gibtype_t type ) ;
...
extern void Use_Flashlight ( edict_t * ent , const gitem_t * item ) ;
...
extern void Use_QuadFire ( edict_t * ent , const gitem_t * item ) ;
...
extern void Use_misc_remote_camera(edict_t *self, edict_t *other, edict_t *activator);
...
extern void actor_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void arachnid_die ( edict_t * self ,  edict_t *inflictor , edict_t *attacker , int damage, const vec3_t point ) ;
...
extern void army_die ( edict_t * self ,  edict_t * inflictor , edict_t * attacker , int damage, const vec3_t point ) ;
...
extern void barrel_die(edict_t *self, edict_t *inflictor, edict_t *attacker, int damage, const vec3_t point) ;
...
extern void biotank_touch (edict_t *self, edict_t *other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void boss5_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void bush_touch (edict_t *self, edict_t *other, const cplane_t * plane , const csurface_t * surf ) ;
...
extern void cactus4_use (edict_t *self, edict_t *other, edict_t *activator) ;
extern void cactus_close(edict_t *self) ;
extern void cactus_open(edict_t *self) ;
extern void cactus_touch (edict_t *self, edict_t *other, const cplane_t * plane , const csurface_t * surf ) ;
...
extern void chest1_anim (edict_t *self) ;
extern void chest1_use (edict_t *self, edict_t *other, edict_t *activator) ;
...
extern void choose_cdtrack_touch ( edict_t *self, edict_t *other, const cplane_t *plane , const csurface_t *surf ) ;
extern void cleanupHealTarget ( edict_t * ent ) ;
extern void cog1_anim (edict_t *self) ;
extern void cog1_use (edict_t *self, edict_t *other, edict_t *activator) ;
...
extern void demon_die ( edict_t * self ,  edict_t * inflictor , edict_t * attacker , int damage, const vec3_t point ) ;
extern void demon_jump_touch ( edict_t * self ,  edict_t * other , const cplane_t *plane , const csurface_t *surf ) ;
...
extern void destructible_die ( edict_t * self ,  edict_t * inflictor , edict_t * attacker , int damage, const vec3_t point ) ;
extern void dog_dead ( edict_t * self ) ;
extern void dog_die ( edict_t * self ,  edict_t * inflictor , edict_t * attacker , int damage, const vec3_t point ) ;
extern void dog_leap ( edict_t * self ) ;
extern void dog_leap_touch ( edict_t * self ,  edict_t * other , const cplane_t *plane, const csurface_t *surf);
...
extern void dying_elf_die (edict_t *self, edict_t *inflictor, edict_t *attacker, int damage, const vec3_t point) ;
extern void dying_elf_idle(edict_t *self) ;
extern void dying_elf_pain (edict_t *self, edict_t *other, float kick, int damage) ;
extern void dying_elf_reach_anim(edict_t *self) ;
extern void dying_elf_sounds (edict_t *self, int type) ;
extern void dying_elf_touch (edict_t *self, edict_t *other, const cplane_t * plane , const csurface_t * surf ) ;
...
extern void env_dust_use ( edict_t *self, edict_t *other, edict_t *activator );
...
extern void fire_spark_gone (edict_t *self, edict_t *other, edict_t *activator);
extern void fire_spark_think(edict_t *self);
extern void fire_spark_use(edict_t *self, edict_t *other, edict_t *activator);
extern void fire_tesla ( edict_t * self , vec3_t start , vec3_t aimdir , int damage_multiplier , int speed ) ;
extern void fire_touch (edict_t *self, edict_t *other, const cplane_t * plane , const csurface_t * surf ) ;
...
extern void fish_anim (edict_t *self) ;
...
extern void fish_melee ( edict_t * self, G_Message_t *msg ) ;
extern void fish_pain ( edict_t * self , G_Message_t * msg ) ;
extern void fish_search ( edict_t * self ) ;
extern void fish_think ( edict_t * ent ) ;
extern void fixbot_attack ( edict_t * self ) ;
extern void fixbot_dead ( edict_t * self ) ;
extern void fixbot_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void flare_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void func_animation_use ( edict_t * self, edict_t * other , edict_t * activator ) ;
...
extern void gekk_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void gekk_jump_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void gladb_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void globebottom_turn (edict_t *self) ;
extern void globebottom_use (edict_t *self, edict_t *other, edict_t *activator) ;
extern void globetop_turn (edict_t *self) ;
extern void globetop_use (edict_t *self, edict_t *other, edict_t *activator) ;
...
extern void guardian_die ( edict_t * self ,  edict_t *inflictor , edict_t *attacker , int damage, const vec3_t point ) ;
...
extern void hivepriestesssymbol_use (edict_t *self, edict_t *other, edict_t *activator) ;
extern void hknight_attack ( edict_t * self ) ;
extern void hknight_dead ( edict_t * self ) ;
extern void hknight_die ( edict_t * self ,  edict_t * inflictor , edict_t * attacker , int damage, const vec3_t point ) ;
...
extern void ionripper_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
extern void ironmaiden_close (edict_t *self) ;
extern void ironmaiden_open (edict_t *self) ;
extern void ironmaiden_touch (edict_t *self, edict_t *other, const cplane_t * plane , const csurface_t * surf ) ;
extern void ironmaiden_use (edict_t *self, edict_t *other, edict_t *activator) ;
...
extern void knight_die ( edict_t * self ,  edict_t * inflictor , edict_t * attacker , int damage, const vec3_t point ) ;
...
extern void larva_anim (edict_t *self) ;
extern void larva_touch (edict_t *self, edict_t *other, const cplane_t * plane , const csurface_t * surf ) ;
extern void lever1_use (edict_t *self, edict_t *other, edict_t *activator) ;
extern void lever1downthink(edict_t *self) ;
extern void lever1upthink(edict_t *self) ;
extern void lever2_use (edict_t *self, edict_t *other, edict_t *activator) ;
extern void lever2downthink(edict_t *self) ;
extern void lever2upthink(edict_t *self) ;
extern void lever3_use (edict_t *self, edict_t *other, edict_t *activator) ;
extern void lever3downthink(edict_t *self) ;
extern void lever3upthink(edict_t *self) ;
extern void lever_used(edict_t *self, G_Message_t *msg) ;
extern void light_use ( edict_t * self , edict_t * other , edict_t * activator ) ;
extern void loogie_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
extern void magic_touch ( edict_t * self, edict_t * other , const cplane_t *plane, const csurface_t *surf) ;
...
extern void misc_hologram_infinity_destroy ( edict_t * self ) ;
extern void misc_hologram_infinity_gib ( edict_t * self ) ;
extern void misc_hologram_infinity_think ( edict_t * self ) ;
extern void misc_hologram_infinity_use ( edict_t * self, edict_t * other /* unused */, edict_t * activator /* unused */ );
extern void misc_hologram_think ( edict_t * ent ) ;
extern void misc_lightning_think ( edict_t * self ) ;
extern void misc_magic_portal_touch(edict_t *self, edict_t *other, const cplane_t * plane , const csurface_t * surf ) ;
extern void misc_magic_portal_use(edict_t *self, edict_t *other, edict_t *activator);
...
extern void monster_dynamic_die ( edict_t *self, edict_t *inflictor, edict_t *attacker, int damage, const vec3_t point ) ;
extern void monster_dynamic_die_noanim ( edict_t *self, edict_t *inflictor, edict_t *attacker, int damage, const vec3_t point ) ;
extern void monster_dynamic_dodge(edict_t *self, edict_t *attacker, float eta, trace_t *tr /* unused */) ;
extern void monster_dynamic_idle ( edict_t * self ) ;
extern void monster_dynamic_melee ( edict_t * self ) ;
...
extern void monsterspawner_go(edict_t *self);
extern void monsterspawner_use(edict_t *self, edict_t *other, edict_t *activator);
...
extern void object_big_fire_think ( edict_t * self ) ;
...
extern void objpush_touch (edict_t *self, edict_t *other, const cplane_t * plane , const csurface_t * surf ) ;
extern void ogle_moan (edict_t *self) ;
extern void ogre_attack ( edict_t * self ) ;
extern void ogre_dead ( edict_t * self ) ;
extern void ogre_die ( edict_t * self ,  edict_t * inflictor , edict_t * attacker , int damage, const vec3_t point ) ;
...
extern void plasma_touch ( edict_t * ent , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void rat_touch(edict_t *ent, edict_t *other, const cplane_t * plane , const csurface_t * surf ) ;
...
extern void rope_touch (edict_t *self, edict_t *other, const cplane_t * plane , const csurface_t * surf ) ;
extern void rope_use (edict_t *self, edict_t *other, edict_t *activator);
...
extern void rotating_light_killed ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void rotfish_dead ( edict_t * self ) ;
extern void rotfish_die ( edict_t * self ,  edict_t * inflictor , edict_t * attacker , int damage, const vec3_t point ) ;
extern void rotfish_melee ( edict_t * self ) ;
extern void rotfish_pain ( edict_t * self ,  edict_t * other , float kick , int damage ) ;
extern void rotfish_search ( edict_t * self ) ;
...
extern void shalrath_die ( edict_t * self ,  edict_t * inflictor , edict_t * attacker , int damage, const vec3_t point ) ;
extern void shalrath_pain ( edict_t * self ,  edict_t * other , float kick , int damage ) ;
extern void shalrath_pod_home ( edict_t * self ) ;
extern void shalrath_pod_touch ( edict_t * self ,  edict_t * other , const cplane_t *plane, const csurface_t * surf ) ;
...
extern void shambler_die ( edict_t * self ,  edict_t * inflictor , edict_t * attacker , int damage, const vec3_t point ) ;
...
extern void shrine_armor_silver_touch ( edict_t *self, edict_t *other, const cplane_t * plane , const csurface_t * surf ) ;
extern void shrine_heal_touch (edict_t *self, edict_t *other, const cplane_t * plane , const csurface_t * surf ) ;
extern void shrine_mana_touch (edict_t *self, edict_t *other, const cplane_t * plane , const csurface_t * surf ) ;
extern void shrine_random_touch (edict_t *self, edict_t *other, const cplane_t * plane , const csurface_t * surf ) ;
extern void shrine_staff_touch ( edict_t *self, edict_t *other, const cplane_t * plane , const csurface_t * surf ) ;
...
extern void soldierh_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
...
extern void spellbook_anim (edict_t *self) ;
extern void spellbook_use (edict_t *self, edict_t *other, edict_t *activator) ;
...
extern void spit_touch ( edict_t * self ,  edict_t * other , const cplane_t *plane, const csurface_t *surf);
...
extern void statue_sithraguard_think (edict_t *self) ;
extern void statue_sithraguard_use (edict_t *self, edict_t *other, edict_t *activator) ;
extern void statue_tchecktrik_bust_use (edict_t *self, edict_t *other, edict_t *activator) ;
...
extern void symbolthink(edict_t *self) ;
...
extern void tarbaby_die ( edict_t * self ,  edict_t *inflictor , edict_t *attacker , int damage, const vec3_t point ) ;
...
extern void tarbaby_touch ( edict_t * self ,  edict_t * other , const cplane_t *plane, const csurface_t *surf);
extern void target_actor_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void target_crossunit_target_think ( edict_t * self ) ;
...
extern void tcheckrik_use (edict_t *self, edict_t *other, edict_t *activator) ;
...
extern void tomb_use (edict_t *self, edict_t *other, edict_t *activator) ;
extern void touch_npc_timeminder ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
...
extern void trigger_crossunit_trigger_use ( edict_t * self , edict_t * other , edict_t * activator ) ;
...
extern void trigger_flashlight_touch ( edict_t * self , edict_t * other , const cplane_t * plane , const csurface_t * surf ) ;
extern void trigger_fog_touch(edict_t *self, edict_t *other, const cplane_t *plane /* unused */, const csurface_t *surf /* unused */);
extern void trigger_fogdensity_touch(edict_t *self, edict_t *other, const cplane_t *plane /* unused */, const csurface_t *surf /* unused */);
extern void trigger_goto_buoy_touch (edict_t *self, edict_t *other, const cplane_t * plane , const csurface_t * surf ) ;
...
extern void trigger_playerpushbutton(edict_t *self, edict_t *other, const cplane_t * plane, const csurface_t * surface ) ;
...
extern void waterdrip_go(edict_t *self);
extern void waterdrip_use (edict_t *self, edict_t *other, edict_t *activator);
...
extern void wizard_die ( edict_t * self ,  edict_t * inflictor , edict_t * attacker , int damage, const vec3_t point);
...
extern void zombie_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , int damage , const vec3_t point ) ;
extern void zombie_die (edict_t * self ,  edict_t * inflictor , edict_t * attacker , int damage, const vec3_t point ) ;
extern void zombie_gib_touch ( edict_t * self ,  edict_t * other , const cplane_t *plane, const csurface_t *surf);
...
extern void zombie_sight ( edict_t * self , edict_t * other ) ;
extern void zombie_touch ( edict_t * self ,  edict_t * other , const cplane_t *plane, const csurface_t *surf);
