...
extern void SP_obj_material_nomoveanddamage( edict_t * self ) ;
extern void SP_obj_material_stopmove( edict_t * self ) ;
...
extern void SP_script_runner( edict_t * self ) ;
...
extern void shrine_armor( edict_t * self ) ;
extern void shrine_armor_gold( edict_t * self ) ;
extern void shrine_ghost( edict_t * self ) ;
extern void shrine_heal( edict_t * self ) ;
extern void shrine_light( edict_t * self ) ;
extern void shrine_lung( edict_t * self ) ;
extern void shrine_mana( edict_t * self ) ;
extern void shrine_powerup( edict_t * self ) ;
extern void shrine_random( edict_t * self ) ;
extern void shrine_reflect( edict_t * self ) ;
extern void shrine_speed( edict_t * self ) ;
extern void shrine_staff( edict_t * self ) ;
