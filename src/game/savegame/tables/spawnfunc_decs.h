...
void SP_func_animation ( edict_t * ent ) ;
...
void SP_item_health_full( edict_t * self ) ;
void SP_item_health_half( edict_t * self ) ;
...
void SP_misc_lightning ( edict_t * ent ) ;
...
void SP_misc_drip ( edict_t * self ) ;
void SP_misc_satellite_dish ( edict_t * ent ) ;
void SP_misc_strogg_ship ( edict_t * ent ) ;
void SP_misc_text_caption ( edict_t * self ) ;
void SP_misc_teleporter ( edict_t * ent ) ;
void SP_misc_teleporter_dest ( edict_t * ent ) ;
void SP_misc_transport ( edict_t * ent ) ;
void SP_misc_update_spawner ( edict_t * self ) ;
...
void SP_obj_corpse( edict_t * self ) ;
...
void SP_obj_material_nomoveanddamage( edict_t * self ) ;
void SP_obj_material_stopmove( edict_t * self ) ;
void SP_obj_metalchunk( edict_t * self ) ;
void SP_obj_minecart( edict_t * self ) ;
void SP_obj_morcalavin_barrier( edict_t * self ) ;
void SP_obj_moss( edict_t * self ) ;
void SP_obj_pipe( edict_t * self ) ;
void SP_obj_pipewheel( edict_t * self ) ;
void SP_obj_plant( edict_t * self ) ;
void SP_obj_rope( edict_t * self ) ;
void SP_obj_ropechain( edict_t * self ) ;
void SP_obj_seasonglobe( edict_t * self ) ;
...
void SP_object_barrel( edict_t * self ) ;
void SP_object_big_fire( edict_t * self ) ;
void SP_object_campfire ( edict_t * self);
void SP_object_flame1 ( edict_t * ent);
void SP_object_repair ( edict_t * ent ) ;
void SP_path_corner( edict_t * self ) ;
void SP_point_combat( edict_t * self ) ;
void SP_quake_light_flame( edict_t * self ) ;
void SP_rotating_light( edict_t * self ) ;
void SP_script_runner( edict_t * self ) ;
...
void shrine_armor( edict_t * self ) ;
void shrine_armor_gold( edict_t * self ) ;
void shrine_ghost( edict_t * self ) ;
void shrine_heal( edict_t * self ) ;
void shrine_light( edict_t * self ) ;
void shrine_lung( edict_t * self ) ;
void shrine_mana( edict_t * self ) ;
void shrine_powerup( edict_t * self ) ;
void shrine_random( edict_t * self ) ;
void shrine_reflect( edict_t * self ) ;
void shrine_speed( edict_t * self ) ;
void shrine_staff( edict_t * self ) ;
