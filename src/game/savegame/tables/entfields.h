...
{"bmodel_anim_alternate", FOFS(bmodel_anim.alternate), F_INT},
...
{"shadowlightradius", STOFS(sl_radius), F_FLOAT, FFL_SPAWNTEMP},
{"shadowlightresolution", STOFS(sl_resolution), F_INT, FFL_SPAWNTEMP},
{"shadowlightintensity", STOFS(sl_intensity), F_FLOAT, FFL_SPAWNTEMP},
{"shadowlightstartfadedistance", STOFS(sl_fade_start), F_FLOAT, FFL_SPAWNTEMP},
{"shadowlightendfadedistance", STOFS(sl_fade_end), F_FLOAT, FFL_SPAWNTEMP},
{"shadowlightstyle", STOFS(sl_lightstyle), F_INT, FFL_SPAWNTEMP},
{"shadowlightconeangle", STOFS(sl_coneangle), F_FLOAT, FFL_SPAWNTEMP},
{"shadowlightstyletarget", STOFS(sl_lightstyletarget), F_LRAWSTRING, FFL_SPAWNTEMP},
{"renderfx", STOFS(renderfx), F_INT, FFL_SPAWNTEMP},
{"rgba", STOFS(rgba), F_RGBA, FFL_SPAWNTEMP},
{"rgb", STOFS(rgba), F_RGBA, FFL_SPAWNTEMP},
{"scale", STOFS(scale), F_SCALE, FFL_SPAWNTEMP},
