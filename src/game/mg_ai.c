...
extern qboolean	enemy_vis;		// TRUE if enemy is visible
extern qboolean	enemy_infront;	// TRUE if enemy is in front
extern int			enemy_range;	// range from enemy RANGE_MELEE, RANGE_NEAR, RANGE_MID, RANGE_FAR
extern float		enemy_yaw;		// ideal yaw to face enemy
