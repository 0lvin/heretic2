...
{	// NOTE We currently have 126 client effects, we cannot exceed 32768 - ha !! Like we'll ever reach that !
	...
	FX_FIREHANDS,
	FX_SHRINE_BALL,
	FX_SHRINE_BALL_EXPLODE,			//105
	FX_OGLE_HITPUFF,
	FX_HP_MISSILE,
	FX_I_EFFECTS,
	FX_CHICKEN_EXPLODE,				//110
	FX_FLAMETHROWER,
	FX_TELEPORT_PAD,
	FX_QUAKE,
	FX_LIGHTNING,
	FX_POWER_LIGHTNING,				//115
	FX_BUBBLE,
	FX_TPORTSMOKE,
	FX_WATER_PARTICLES,
	FX_M_EFFECTS,
