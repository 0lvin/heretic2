...
#define PAL_SIZE		256
#define	MIPLEVELS16		16

typedef struct miptex8_s
{
	int			version;
	char		name[32];
	unsigned	width[MIPLEVELS16], height[MIPLEVELS16];
	unsigned	offsets[MIPLEVELS16];		// four mip maps stored
